...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, UC_UMLU, _______, UC_UMLO, _______, _______, _______, QK_BOOT,
        _______, UC_UMLA, _______, _______, _______, _______, _______, _______, _______, _______, UC_UML,  UC_ACUT,          _______,
        _______,          UC_MAC,  UC_LINX, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______
    ),
    [3] = LAYOUT_60_ansi(
        _______, _______, _______, _______, _______, _______, UC_CFLX, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, UC_ACTE, _______, _______, _______, UC_ACTU, UC_ACTI, UC_ACTO, _______, _______, _______, QK_BOOT,
        _______, UC_ACTA, _______, _______, _______, _______, _______, _______, _______, _______, UC_UML,  UC_ACUT,          _______,
        _______,          UC_MAC,  UC_LINX, _______, _______, _______, UC_TLDN, _______, _______, _______, _______,          _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______
    )
};
